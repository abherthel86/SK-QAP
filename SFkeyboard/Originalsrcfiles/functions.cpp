...
void initSol2 (Gendata *data, Keyboard *keyb){
	...
	keyb->grid[33] = data->size - 1;
	keyb->grid[34] = data->size - 2;
	keyb->grid[35] = data->size - 3;
	keyb->grid[36] = data->size - 4;
	keyb->grid[37] = data->size - 5;

	keyb->assignment[data->size - 1] = 33;
    keyb->assignment[data->size - 2] = 34;
    keyb->assignment[data->size - 3] = 35;
    keyb->assignment[data->size - 4] = 36;
    keyb->assignment[data->size - 5] = 37;

	assigned_char.push_back(data->size - 1);
	assigned_char.push_back(data->size - 2);
	assigned_char.push_back(data->size - 3);
	assigned_char.push_back(data->size - 4);
	assigned_char.push_back(data->size - 5);

	aux_charl.remove(data->size - 1);
	aux_charl.remove(data->size - 2);
	aux_charl.remove(data->size - 3);
	aux_charl.remove(data->size - 4);
	aux_charl.remove(data->size - 5);
